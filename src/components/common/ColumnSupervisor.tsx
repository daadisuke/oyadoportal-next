      ...
      <div className={`${styles['supervision']}`}>
        ...
        <div className={`${styles['supervision__info']}`}>
          ...
          <dl className={`${styles['supervision__info-text']}`}>
            <dt>
              <span>株式会社お宿ポータル代表</span>野井 裕司
            </dt>
            <dd>
              帰国後は複数のベンチャー企業のスタートアップ、経営に携わり、2001年、経営コンサルタントとして独立。事業再生、海外市場進出、コンテンツマーケティングなどを中心に指導を行っている。米国のベストセラー『インバウンド
              マーケティング』（すばる舎リンケージ）の翻訳者。明治学院大学院経済学部経営学科博士課程修了、経営学修士。
            </dd>
          </dl>
        </div>
      </div>
