      ...
      {data.datacolumn.map((value: any) => {
        ...
        if (value['column_category'][0] === 2 && categoryFlag01 == false) {
          ...
          return (
            <>
              <li>
                <Link href={`/column_category/it_support`}>ITサポート</Link>
              </li>
            </>
          );
          ...
          return (
            <>
              <li>
                <Link href={`/column_category/human_resources_missing_resolution}`}>人手不足解消</Link>
              </li>
            </>
          );
          ...
          return (
            <>
              <li>
                <Link href={`/column_category/facility_introduction`}>設備導入・改修</Link>
              </li>
            </>
          );
          ...
          return (
            <>
              <li>
                <Link href={`/column_category/fund_missing_resolution`}>資金不足解消</Link>
              </li>
            </>
          );
          ...
          return (
            <>
              <li>
                <Link href={`/column_category/customer_acquisition_support`}>集客サポート</Link>
              </li>
            </>
          );
        }
