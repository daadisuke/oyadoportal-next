        ...
        <div className={styles['l-header__inner']}>
          ...
          <div className={styles['l-header__inner-rblock-wrap']}>
            <div className={styles['l-header__inner-consultation']}>
              ...
              <div className={styles['l-header__inner-consultation-button']}>
                <Link href="tel:03-6823-2455">
                  <p className={styles['l-header__inner-consultation-button-contacttext']}>お電話でのお問い合わせ</p>
                  <p className={styles['l-header__inner-consultation-button-tel']}>
                    <Image
                      src="/common/header__tel.svg"
                      alt="電話番号"
                      width={30}
                      height={29}
                    />
            ...
            <nav className={styles['l-header__inner-navi']}>
              <ul className={styles['l-header__inner-navi-gnavi']}>
                <li>
                  <Link href="/#problem">サービス内容</Link>
                </li>
                <li>
                  <Link href="/case/">事例紹介</Link>
                </li>
                <li>
          ...
          <button
            className={styles['fullScreenMenu-button']}
            type="button"
            aria-label="メニューを開く"
          >
