  ...
  return (
    <>
      <div className={styles['c-heading']}>
        <h1 className={styles['c-heading__pageTitle']}>問い合わせ</h1>
      </div>
        ...
        <div className={styles['l-section__inner']}>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <dl>
                ...
                <dd>
                    ...
                    <span key={index}>
                      <input
                        ...
                        {...register(`your_contact_item`, {
                          validate: {
                            atLeastOneRequired: (value) => value.length >= 1 || '1つ以上選択してください',
                          },
                        })}
                      />
                  ...
                  {errors.your_contact_item && (
                    <div className="c-error-message">{errors.your_contact_item.message}</div>
                  )}
                </dd>
                <dt>
                  <label htmlFor="your_facility_name">施設名</label>
                  <span>必須</span>
                </dt>
                <dd>
                  <input
                ...
                <dt>
                  <label htmlFor="your_name">氏名</label>
                  <span>必須</span>
                </dt>
                <dd>
                  <input
                ...
                <dt>
                  <label htmlFor="your_name_kana">フリガナ</label>
                  <span>必須</span>
                </dt>
                <dd>
                  <input
                ...
                <dt>
                  <label htmlFor="your_email">メールアドレス</label>
                  <span>必須</span>
                </dt>
                <dd>
                  <input
                ...
                <dt>
                  <label htmlFor="your_email_confirm">メールアドレス（確認用）</label>
                  <span>必須</span>
                </dt>
                <dd>
                  <input
                  ...
                  />
                  {errors.your_email_confirm && (
                    <div className="c-error-message">確認メールアドレスを正しく入力してください</div>
                  )}
                </dd>
                <dt>
                  <label htmlFor="your_zip_code">郵便番号</label>
                </dt>
                <dd>
                  <input
                    type="text"
                ...
                <dt>
                  <label htmlFor="your_prefecture">都道府県</label>
                </dt>
                <dd>
                  <select
                    className={styles['text-ss']}
                    name="your_prefecture"
                  >
                ...
                <dt>
                  <label htmlFor="your_city">市区町村</label>
                </dt>
                <dd>
                  <input
                    type="text"
                ...
                <dt>
                  <label htmlFor="your_chome_address">丁目番地</label>
                </dt>
                <dd>
                  <input
                    type="text"
                    name="your_chome_address"
                    placeholder="丁目番地"
                  />
                </dd>
                <dt>
                  <label htmlFor="your_building_name">建物名</label>
                </dt>
                <dd>
                  <input
                    type="text"
                    name="your_building_name"
                    placeholder="建物名"
                  />
                </dd>
                <dt>
                  <label htmlFor="your_phone_number">お電話番号</label>
                  <span>必須</span>
                </dt>
                <dd>
                  <input
                ...
                <dt>
                  <label htmlFor="your_contact_content">お問い合わせ内容</label>
                  <span>必須</span>
                </dt>
                <dd>
                  <textarea
            ...
            <div className={styles['contact-main__check']}>
              <p>
                <a href="">個人情報保護方針</a>を必ずお読みください。
                <br />
                上記の内容に同意いただいた場合は、確認画面へお進みください。
              </p>
