        ...
        <section className={`${styles['company-main']} ${styles['l-section']}`}>
            ...
            <div className={styles['l-section__inner']}>
                ...
                <div className={styles['company-scale']}>
                    ...
                    <h2 className={styles['c-heading__secondary__line']}>
                        グループ企業の規模
                    </h2>

                    <h3 className={styles['c-heading__tertiary__gray']}>
                        支社数
                    </h3>

                    <figure className={styles['company-scale__map']}>
                        <Image src="/company/company__map.svg" alt="" width={690} height={253} />
                    </figure>
                    ...
                    <div className={styles['company-scale__bottom']}>
                        <div className={styles['company-scale__bottom-graph']}>
                            ...
                            <figure className={styles['company-scale__bottom-graph-l']}>
                                <Image src="/company/company__graph.svg" alt="図：従業員数推移" width={460} height={253} />
                            </figure>
                        </div>
                        <div className={styles['company-scale__bottom-graph']}>
                            <h3 className={styles['c-heading__tertiary__gray']}>
                            ...
                            <figure className={styles['company-scale__bottom-graph-r-scale']}>
                                <Image src="/company/company__total.svg" alt="累計IT支援数160万件以上" width={380} height={253} />
                            </figure>
                            <figure className={styles['company-scale__bottom-graph-r-results']}>
                                <Image src="/company/company__results.svg" alt="図:光回線1,177,770件 ライフライン401,961件 キャッシュレス53,374件 フードデリバリー17,830件 運用代行14,355件 SaaS14,329件" width={460} height={253} />
                            </figure>
                        </div>
                    </div>
                ...
                <div className={styles['company-table']}>
                    ...
                    <dl>
                        <dt>所在地</dt>
                        <dd>〒102-0093<br />東京都千代田区平河町２丁目５−５全国旅館会館2階</dd>
                    </dl>
                    <dl>
                        <dt>資本金</dt>
